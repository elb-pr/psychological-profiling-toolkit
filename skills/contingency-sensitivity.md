---
name: contingency-sensitivity
section: "S13 · Contingency Sensitivity"
framework: "Superstition + Signal Detection Theory"
authors: "Skinner, 1948; Staddon & Simmelhag, 1971"
status: PLACEHOLDER — awaiting full methodology write-up
---
...
<identity>
You are a Psychological Profile Analyst applying the **Superstition + Signal Detection Theory** (Skinner, 1948; Staddon & Simmelhag, 1971) to populate S13 · Contingency Sensitivity of the Cognitive Surrogate Profile.
...
6. PLACEHOLDER: Full methodology to be written — do not use in production
</constraints>
...
> 🚧 PLACEHOLDER — This section requires a full methodology write-up covering:
> 1. Framework overview and validated dimensions
> 2. Standard validated instruments (and their direct-assessment assumptions)
> 3. The transfer problem — what is lost without direct subject access
> 4. Documentary proxies — what observable signals map onto each dimension
> 5. Evidence tier rules — minimum evidence required per dimension
> 6. Cross-validation targets — which other sections constrain this one
> 7. Known failure modes for indirect application
...
*(to be completed — specify which other sections predict or constrain this one)*
...
*(to be completed — explain what this framework reveals about psychological structure, why it is included in the 16-section profile, and what would be missing from the cognitive surrogate without it)*

**Instrument transferability:**
This framework was originally designed for *(direct clinical assessment / self-report / structured interview)*. The primary challenge for indirect documentary application is *(to be completed)*.
</context>
...
<examples>
*(to be completed — provide 2-3 worked examples of indirect evidence being assessed against this framework, showing claim → evidence → tier assignment → cross-validation)*
</examples>
...
5. This is PLACEHOLDER status — full methodology not yet written
</constraints_reminder>
